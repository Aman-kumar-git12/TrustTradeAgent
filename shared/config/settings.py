...
# Path resolution:
# Agent/shared/config/settings.py -> parents[2] reaches the Agent/ directory
...
class Settings:
    ...
    backend_empty_search_retry_delay_seconds: float = float(os.getenv('BACKEND_EMPTY_SEARCH_RETRY_DELAY_SECONDS', '0.8'))
